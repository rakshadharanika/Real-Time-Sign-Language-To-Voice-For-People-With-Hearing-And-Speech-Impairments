  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-success-foreground shadow-md hover:shadow-lg hover:brightness-110",
        accent: "bg-accent text-accent-foreground shadow-md hover:shadow-lg hover:brightness-110",
        touch: "min-h-[56px] min-w-[56px] bg-primary text-primary-foreground shadow-md hover:shadow-glow",
        touchOutline: "min-h-[56px] min-w-[56px] border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground",
        touchSecondary: "min-h-[56px] min-w-[56px] bg-secondary text-secondary-foreground shadow-sm hover:shadow-md",
      },
      size: {
